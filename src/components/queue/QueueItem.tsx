...
export function QueueItem({
  ...
  return (
    <li
      className={`group/item relative grid min-h-9 grid-cols-[18px_minmax(0,1fr)_auto_auto] items-center gap-1.5 rounded-lg px-1 py-0.5 select-none motion-safe:animate-queue-item-in transition-[background-color,box-shadow,opacity,transform] duration-200 ease-out hover:z-10 hover:bg-queue-surface-muted hover:shadow-[inset_0_0_0_1px_var(--queue-border),0_3px_12px_rgb(0_0_0_/_12%)] data-[can-drag]:cursor-grab data-[dragging]:z-20 data-[dragging]:scale-[0.985] data-[dragging]:cursor-grabbing data-[dragging]:bg-queue-surface-muted data-[dragging]:opacity-55 data-[dragging]:shadow-[inset_0_0_0_1px_var(--queue-accent),0_8px_24px_rgb(0_0_0_/_24%)] data-[drag-over]:z-10 data-[drag-over]:bg-queue-surface-muted data-[drag-over]:shadow-[inset_0_0_0_1px_var(--queue-accent)] max-[560px]:grid-cols-[18px_minmax(0,1fr)_auto]${isExiting ? " pointer-events-none overflow-hidden motion-safe:animate-queue-item-out" : ""}`}
